import { CartActionTypes, AddProductToCartAction, DecreaseProductCountAction, IncreaseProductCountAction, ClearCartAction, DeleteProductFromCardAction } from "../../types/cart";
import { Product } from "../../types/products";
// import { DeleteProductFromCardAction } from './../../types/cart';

export const addProductToCart = (product: Product, count: number = 1): AddProductToCartAction => {
